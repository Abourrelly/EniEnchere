                ...
                <div class="card border-primary" style="max-width: 100rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row col-sm-12 mt-2">
                            ...
                            <button id="buttonSearch" type="button" class="btn btn-primary btn-lg btn-block col-sm-4">Rechercher
                            </button>
                            <div class="col-sm-4"></div>
                        </div>
                    </div>
                    ...
                    <a href="ressource/article/<%=article.getIdArticle() %>.jpg"
                       ...
                       title="<%=article.getNom()%>">
                        <img src="ressource/article/<%=article.getIdArticle() %>.jpg" class="img-card-shop card-img-top"
                             alt="image">
                        <%if (LocalDate.now().isEqual(LocalDate.parse(article.getDateDebutEncheres()))) {%>
