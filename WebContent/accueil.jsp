...
<div class="container">
    <div class="row">
        ...
        <div class="d-flex col-sm-12 mt-5 align-items-center justify-content-center">
            <div class="card mb-3">
                <h3 class="card-header text-center text-primary"><%=article.getNom() %></h3>
                <div class="card-body">
                    <h5 class="card-title text-center text-secondary"><%=article.getCategorie().getLibelle()%></h5>
                </div>
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">Prix : <%=article.getPrixVente() %> points</li>
                    <li class="list-group-item">Vendu par : <a href="#" class="card-link"> <%=article.getUtilisateur().getPseudo()%></a></li>
                </ul>
                <div class="card-body text-center text-secondary">
                	Enchère débutée le <%=article.getDateDebutEncheres()%>                    
                </div>
